...
@section('title', 'Cookie Policy - Pita Queen')
@section('meta_description', 'Cookie Policy describing essential, analytics, and preference cookies used by Pita Queen website services.')
    ...
    <script type="application/ld+json">
        {
            ...
            "description": "Cookie Policy for Pita Queen website users.",
            "isPartOf": {
                "@@type": "WebSite",
    ...
    <section class="section-padding legal-page">
        <div class="container" style="max-width: 840px;">
            <div class="mb-4">
                ...
                <h1 class="section-title mt-3">Cookie Policy</h1>
            ...
            <div class="contact-form legal-content" style="display: grid; gap: 1.5rem;">
                ...
                <div class="legal-section">
                    ...
                    <p>You can also review our <a href="{{ route('legal.privacy') }}">Privacy Policy</a> and <a href="{{ route('legal.terms') }}">Terms of Service</a>.</p>
                </div>
            </div>
        </div>
    </section>
