...
@section('title', 'Privacy Policy - Pita Queen')
@section('meta_description', 'Pita Queen Privacy Policy for restaurant website visitors, feedback submissions, cookies, analytics, and customer data rights.')
    ...
    <script type="application/ld+json">
        {
            ...
            "description": "Privacy Policy for Pita Queen website users and customers.",
            "isPartOf": {
                "@@type": "WebSite",
    ...
    <section class="section-padding legal-page">
        <div class="container" style="max-width: 840px;">
            ...
            <div class="legal-top-links" aria-label="Legal page links">
                ...
                <a class="legal-link-chip" href="{{ route('legal.terms') }}">Terms of Service</a>
            ...
            <div class="contact-form legal-content" style="display: grid; gap: 1.5rem;">
                ...
                <div class="legal-section" id="privacy-contact">
                    <h2 style="font-size: 1.2rem;">Need help?</h2>
                    <p>You can also review our <a href="{{ route('legal.terms') }}">Terms of Service</a> and <a href="{{ route('legal.cookies') }}">Cookie Policy</a>.</p>
                </div>
            </div>
        </div>
    </section>
